...
EB paper â€” Wine dataset experiment.

Binary classification: Wine class 0 (positive) vs rest.
4 features via PCA after StandardScaler, angle encoding (RY), 4 qubits/register.

Outputs (in outputs/)
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  wine_raw_results.csv
  wine_raw_predictions.csv
  wine_summary.csv
  wine_summary_numeric.csv
  wine_accuracy.png
  wine_f1_score.png
  wine_circuit.png / .txt
"""
...
def load_dataset(n_features: int = 4) -> tuple[np.ndarray, np.ndarray]:
    """
    Wine binary: class 0 (positive, label +1) vs classes 1 and 2 (label -1).
    StandardScaler â†’ PCA(n_features) â†’ normalized to [0, Ï€] at split time.
    """
    data = load_wine()
...
def main(
    ...
    print("\n" + "=" * 78)
    print(f"WINE â€” EB vs QSVC vs CLASSICAL BASELINES")
    print("=" * 78)
